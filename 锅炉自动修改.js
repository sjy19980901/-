...
(function() {
    ...
    function core(){
        obsSleep(3)
        .then(() => obsIsPage("https://www.mercari.com/",2,"当前页面符合条件"))
        .then(() => {
            let href = window.location.href;
            console.log(href)
            if(href.indexOf("listings") > -1){
                ...
                goHref();
            }else if(href.indexOf("/sell/edit") > -1){
                getPage(href)
                getCount(href)
                update();
            }
    ...
    function getCount(href){
        if(href.indexOf("count=") === -1){
            count = 1;
        }else{
            let idx = href.indexOf("count=") + 6;
            let str = href.substring(idx);
            count = parseInt(str);
        }
    }
    ...
    function goHref(){
        let id = getId('li[data-testid="ListingRow"]:nth-of-type('+count+') a[data-testid="ProductThumbWrapper"]')
        window.location.href = "https://www.mercari.com/sell/edit/"+id+"/?page="+page+"&count="+count;
    }
    ...
    function update(){
        ...
        .then(() => {
            ...
            window.location.href = "https://www.mercari.com/mypage/listings/active/?page="+page + "&count=" + count;
        })
    }
    ...
    function getId(selector) {
        ...
        return href.replace("https://www.mercari.com/us/item/","").replace("/","");
    }
})();
